...
- **79 tools** across 11 categories (Discord, Thread, Forum, Memory, Scheduler, Web, System, CodeGen, HTTP, Skills, Vision)
...
| **Forum** | 5 | `create_forum` `create_forum_post` `list_forum_posts` `manage_forum_tags` `edit_forum` |
